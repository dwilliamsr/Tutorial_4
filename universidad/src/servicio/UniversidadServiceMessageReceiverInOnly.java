...
/**
 * UniversidadServiceMessageReceiverInOnly.java
 *
 ...
 */
        ...
        /**
        *  UniversidadServiceMessageReceiverInOnly message receiver
        */

        public class UniversidadServiceMessageReceiverInOnly extends org.apache.axis2.receivers.AbstractInMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("updateProfesor".equals(methodName)){
            
            service.UpdateProfesor wrappedParam = (service.UpdateProfesor)fromOM(
                                                        inMessage.getEnvelope().getBody().getFirstElement(),
                                                        service.UpdateProfesor.class,
                                                        getEnvelopeNamespaces(inMessage.getEnvelope()));
                                            
                                                     skel.updateProfesor(wrappedParam);
