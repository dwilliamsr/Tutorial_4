...
public class ProfesorService {
  ...
  protected ProfesorDTO find(String profesorID) {
    ...
    protected void insert(String cedula, String nombre, String titulo, String area, String telefono) {
     ProfesorDTO prof = new ProfesorDTO();
  ...
  protected void update(String cedula, String nombre, String titulo, String area, String telefono) {
     if (!profesores.containsKey(cedula)) return;
     ProfesorDTO prof = (ProfesorDTO)profesores.get(cedula);
     prof.setCedula(cedula);
     prof.setArea(area);
     prof.setNombre(nombre);
     prof.setTitulo(titulo);
